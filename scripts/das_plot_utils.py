...
def plot_multiple_event_summaries(event_summary_dict: Dict[str, pd.DataFrame],
                                  ...
                                  filename: str):
    """
    Plot stacked bar charts for multiple DAS event summaries per software.
...
def plot_venn_per_event_vennlib(event_dict: Dict[str, dict],
                                ...
                                filename: str):
    """
    Plot Venn diagrams per DAS event showing overlap between software.
    """
...
def plot_upset_per_event_combined(event_dict: Dict[str, dict],
                                  ...
                                  ncols: int = 2):
    """
    Plot UpSet plots for multiple DAS events and combine them into a single image.
    """
